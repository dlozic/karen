...
class CreateTimezonesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('app_timezones', function (Blueprint $table) {
            $table->id();
        ...
        $timezones->each(function($description, $name) {
            Timezone::create(compact('name', 'description'));
        });
    }
    ...
    {
        Schema::dropIfExists('app_timezones');
    }
}
